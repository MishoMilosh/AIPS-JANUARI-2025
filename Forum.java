...
public class Forum {
    ...
    public static void forum(SLL<Discussion> health, SLL<Discussion> finance)
    {
        ...
        SLLNode<Discussion> temp = null;
        int minimportance = Integer.MAX_VALUE;
        while(dvizi != null)
        {
            int importance1 = 0;
            importance1 = dvizi.element.getPopularity() * dvizi.element.getUsers();
            if(importance1 < minimportance)
            {
                minimportance = importance1;
                temp = dvizi;
            }
            dvizi = dvizi.succ;
        }
        ...
        SLLNode<Discussion> temp2 = null;
        int maximportance = Integer.MIN_VALUE;
        while(dvizi2 != null)
        {
            int importance2 = 0;
            importance2 = dvizi2.element.getPopularity() * dvizi2.element.getUsers();
            if(importance2 > maximportance)
            {
        ...
        finance.insertLast(temp2.element);
    }
