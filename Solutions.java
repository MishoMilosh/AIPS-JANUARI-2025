...
public class Solutions
{
    ...
    {
        SLLNode najmal_qa = qaTeam.getFirst();
        SLLNode najmal = null;
        SLLNode dvizi = devTeam.getFirst();
        int min = 99999;
        while(najmal_qa != null)
        {
            if(najmal_qa.age <= min)
            {
                min = najmal_qa.age;
                najmal = najmal_qa;
            }
            najmal_qa = najmal_qa.succ;
        }
        ...
        devTeam.insertBefore(najmal.id, najmal.age, dvizi);
    }

    public static void main(String[] args)
    {
        SLL developers = new SLL();
        SLL qa = new SLL();
